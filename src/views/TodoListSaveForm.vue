<template>
    <section class="todo-form">
        ...
        <b-container class="bv-example-row">
            ...
            <b-row class="justify-content-md-center mb-2">
                <b-col>
                    <b-form-textarea placeholder="내용" v-model="contentVal" ref="content" style="height: 400px;" :readonly="isReadonly"></b-form-textarea>
                </b-col>
            </b-row>
        </b-container>
        <b-button variant="secondary" type="button" v-on:click="this.$router.push('/list')" style="margin-right: 20px;">목록</b-button>
